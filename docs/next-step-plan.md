...
- ✅ 2026-03-25 已修复 GitHub Actions 构建架构漂移：`desktop-macos.yml` 与 `release-desktop.yml` 现固定使用 `macos-13` Intel runner，避免 `macos-latest` 构建出 `aarch64` 桌面包后，在当前 x64 Ventura 开发机上提示“不支持此应用程序”
